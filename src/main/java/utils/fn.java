...
public class fn {
    public static String a(File file, String string) {
        ...
        try {
            ...
            long l2 = Files.readAttributes(file.toPath(), BasicFileAttributes.class, new LinkOption[0]).creationTime().to(TimeUnit.MILLISECONDS);
            if (l2 > Long.MIN_VALUE && l2 < Long.MAX_VALUE) {
                date = new Date(Files.readAttributes(file.toPath(), BasicFileAttributes.class, new LinkOption[0]).creationTime().to(TimeUnit.MILLISECONDS));
            }
        }
    ...
    public static void a(String string, String string2, boolean bl) {
        try {
            ...
            httpURLConnection.addRequestProperty(class11.sb()[14], class11.sb()[13]);
    ...
    public static void a(File file, List<String> list, boolean bl, boolean bl2) {
