...
public class eJ
    ...
    public eJ(int n2, int n3, int n4, int n5, Component component) {
        ...
        this.c.b(false);
        this.d = DeadCode.n.a("Other", "Save");
        this.e = DeadCode.n.a("Other", "Delete");
        this.f = DeadCode.n.a("Other", "Load");
        eC eC2 = DeadCode.n.a("Other", "Add");
        this.g = new df(this, n2, n3, 62, 16, this, eC2, "New config", aX.h);
        eC2 = DeadCode.n.a("Other", "Search");
    ...
    public void e() {
        try {
            int n2 = 3;
            int n3 = 30;
            for (File file : class6.b.listFiles()) {
                if (file.getName().equals(class6.c.getName())) continue;
                boolean bl = false;
