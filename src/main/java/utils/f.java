 ...
 */
import mahiro.deadcode.excluded.i;
    ...
    public static void a(Entity entity, double d2) {
        ...
        if (entityPlayerSP == entity) {
            if (!(minecraft.playerController instanceof i)) {
                GameType gameType = (GameType)ReflectionHelper.getPrivateValue(PlayerControllerMP.class, (PlayerControllerMP)minecraft.playerController, (String[])new String[]{MappingManager.fieldCurrentGameType});
