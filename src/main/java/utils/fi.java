...
public class fi {
    ...
    private final String b = class6.d.getAbsolutePath() + File.separator;
    private final ArrayList<String> c;
    private final ArrayList<eC> d;
    private boolean e;
    private boolean f;
    private int g;

    public fi() {
        this.a = class6.f.getAbsolutePath() + File.separator + "avatar";
    ...
    public void a() {
        ...
        String string = class11.a()[0] + class11.a()[10] + class26.sbbb(class22.truee());
    ...
    public void a(boolean bl) {
        ...
        for (Object object : this.d) {
            file = new File(((eC)object).e(), ((eC)object).c() + class11.sbbbb()[3]);
            if (!file.exists()) {
                fn.a(class11.a()[0] + class11.a()[5] + ((eC)object).f() + "/" + ((eC)object).c() + ".png", ((eC)object).d());
