 ...
 */
package mahiro.deadcode.deadcode.hack;
...
extends n {
    ...
    public Hack(final String string, HackCategory hackCategory) {
        this.name = string;
    ...
    public String l() {
        ...
        String object = this.getName() + string;
        if (((Boolean) HUD.l.getObjectValue()).booleanValue() && this.hasBind()) {
            object = object + " \u00a7f> " + this.getKeyString();
        }
        this.l = Wrapper.INSTANCE.p().a(object);
    ...
    public void toggle() {
        if ((Sleep.a && !getName().equals("Sleep")) || !u())
            return;
        l();
        this.e = !this.e;
        if (this.e) {
            this.m();
            DeadCode.p.a("ON", this.getName(), aX.i, aX.i, 0.01);
            this.onEnable();
        } else {
            DeadCode.p.a("OFF", this.getName(), aX.l, aX.l, 0.01);
            this.onDisable();
        }
    ...
    public boolean onPacket(final Object object, bw bw2) {
        return true;
    }
    ...
    protected boolean a(Object object, bw bw2) {
        return false;
    }
}
