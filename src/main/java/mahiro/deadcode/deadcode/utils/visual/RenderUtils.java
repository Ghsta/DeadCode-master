...
import mahiro.deadcode.deadcode.utils.MathUtils1;
...
public class RenderUtils {
        ...
        try {
            ...
            if (bl2) {
                ...
                if (entity instanceof EntityLivingBase && bl3) {
                    ...
                    if ((double)((EntityLivingBase) entity).getHealth() > 0.0) {
                        double d5 = (double)((EntityLivingBase) entity).getHealth() / (double)((EntityLivingBase) entity).getMaxHealth();
    ...
    public static void a(EntityPlayer entityPlayer, int n2, int n3, int n4, int n5, int n6) {
        int n7;
        Collection<PotionEffect> collection = entityPlayer.getActivePotionEffects();
    ...
    public static void a(String string, int n2) {
        try {
            byte[] byArray = class11.g(string);
            BufferedImage bufferedImage = class11.a(byArray);
    ...
    public static void a(String string, float f2, float f3, float f4, float f5, float f6, boolean bl, int n2) {
        if (f4 < 1.0f || f5 < 1.0f || !DeadCode.n.d()) {
            return;
        }
        int n3 = -1;
        if (c.containsKey(n2)) {
