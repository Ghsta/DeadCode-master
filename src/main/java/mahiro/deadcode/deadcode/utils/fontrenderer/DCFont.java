 ...
 */
package mahiro.deadcode.deadcode.utils.fontrenderer;
...
public class DCFont {
    ...
    public DCFont(Font font, boolean bl, boolean bl2) {
        ...
        this.c = bl;
        this.d = bl2;
        this.g = this.charDataArray(font, bl, bl2, this.a);
    }

    public DynamicTexture charDataArray(Font font, boolean bl, boolean bl2, CharData[] charDataArray) {
    ...
    public void a(boolean bl) {
        if (this.c != bl) {
            this.c = bl;
            this.g = this.charDataArray(this.b, bl, this.d, this.a);
        }
    }
    ...
    public void b(boolean bl) {
        if (this.d != bl) {
            this.d = bl;
            this.g = this.charDataArray(this.b, this.c, bl, this.a);
        }
    }
    ...
    public void a(Font font) {
        this.b = font;
        this.g = this.charDataArray(font, this.c, this.d, this.a);
    }
}
