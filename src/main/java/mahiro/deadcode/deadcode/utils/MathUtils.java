...
import net.minecraft.util.math.Vec3d;import utils.*;
...
public class MathUtils {
    ...
    public static float[] a(Vec3d vec3d, boolean bl) {
        ...
        if (bl) {
            vec3d2.addVector(Wrapper.INSTANCE.getLocalPlayer().motionX, Wrapper.INSTANCE.getLocalPlayer().motionY, Wrapper.INSTANCE.getLocalPlayer().motionZ);
        }
