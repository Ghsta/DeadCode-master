 ...
 */
package mahiro.deadcode.deadcode.utils.shader;

import classes.class11;
import classes.class26;
...
import org.lwjgl.opengl.GL20;import utils.*;
...
public abstract class ShaderProgram {
    ...
    public void b(String string) {
        ...
        if (file.exists()) {
            ...
            try {
                fn.a(class11.sb()[0] + class11.sb()[1] + string.replace(class11.sb()[2], ".txt"), string2);
    ...
    private /* synthetic */ String c(String string) {
        String string2 = class6.e.getAbsolutePath();
    ...
    private /* synthetic */ int readShaderFromFile(String string, int n2) {
        ...
        try {
            String string2;
            String[] stringArray = class11.sb();
            String string3 = System.getProperty("line.separator");
            FileReader fileReader = new FileReader(string);
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            while ((string2 = bufferedReader.readLine()) != null) {
                string2 = class26.sb(string2, stringArray[0], stringArray[1]);
