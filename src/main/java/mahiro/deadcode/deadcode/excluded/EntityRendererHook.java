...
extends EntityRenderer {
    ...
    public void getMouseOver(float f2) {
        try {
            ...
            if (entity != null && this.g.world != null) {
                this.g.mcProfiler.startSection("pick");
                ...
                if (NoInteract.a && rayTraceResult != null && rayTraceResult.typeOfHit == RayTraceResult.Type.BLOCK && rayTraceResult.getBlockPos() != null) {
                    for (Block block : NoInteract.b) {
                        if (utils.eS.b(rayTraceResult.getBlockPos()) != block) continue;
                        bl = false;
                    }
                }
                if (bl) {
                ...
                this.m = null;
                Vec3d vec3d4 = null;
                List list = this.g.world.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().expand(vec3d2.x * d2, vec3d2.y * d2, vec3d2.z * d2).grow(1.0, 1.0, 1.0), Predicates.and((Predicate)EntitySelectors.NOT_SPECTATING));
                double d4 = d3;
    ...
    private /* synthetic */ void updateLightmap(float f2) {
        if (this.G) {
            this.g.mcProfiler.startSection("lightTex");
    ...
    public void renderWorld(float f2, long l2) {
        ...
        this.g.mcProfiler.startSection("center");
        if (this.g.gameSettings.anaglyph) {
            b = 0;
    ...
    private /* synthetic */ void renderWorldPass(int n2, float f2, long l2) {
        ...
        this.g.mcProfiler.endStartSection("clear");
        ...
        this.g.mcProfiler.endStartSection("camera");
        ...
        this.g.mcProfiler.endStartSection("frustum");
        ClippingHelperImpl.getInstance();
        this.g.mcProfiler.endStartSection("culling");
        ...
        if (this.g.gameSettings.renderDistanceChunks >= 4 && !Optimization.a) {
            this.setupFog(-1, f2);
            this.g.mcProfiler.endStartSection("sky");
            GlStateManager.matrixMode((int)5889);
            GlStateManager.loadIdentity();
        ...
        if (!this.T) {
            ...
            this.g.mcProfiler.endStartSection("entities");
        ...
        if (bl && this.g.objectMouseOver != null && !entity.isInsideOfMaterial(Material.WATER)) {
            ...
            GlStateManager.disableAlpha();
            this.g.mcProfiler.endStartSection("outline");
        ...
        this.g.mcProfiler.endStartSection("destroyProgress");
        ...
        if (!this.T) {
            this.enableLightmap();
            this.g.mcProfiler.endStartSection("litParticles");
            particleManager.renderLitParticles(entity, f2);
            RenderHelper.disableStandardItemLighting();
            this.setupFog(0, f2);
            this.g.mcProfiler.endStartSection("particles");
            particleManager.renderParticles(entity, f2);
            this.disableLightmap();
        }
        GlStateManager.depthMask((boolean)false);
        GlStateManager.enableCull();
        this.g.mcProfiler.endStartSection("weather");
        ...
        this.g.getTextureManager().bindTexture(TextureMap.LOCATION_BLOCKS_TEXTURE);
        GlStateManager.shadeModel((int)7425);
        this.g.mcProfiler.endStartSection("translucent");
        ...
        if (entity.posY + (double)entity.getEyeHeight() >= 128.0) {
            this.g.mcProfiler.endStartSection("aboveClouds");
            this.renderCloudsCheck(renderGlobal, f2, n2, d2, d3, d4);
        }
        this.g.mcProfiler.endStartSection("forge_render_last");
        ForgeHooksClient.dispatchRenderLast((RenderGlobal)renderGlobal, (float)f2);
        this.g.mcProfiler.endStartSection("hand");
        if (this.A) {
    ...
    private /* synthetic */ void renderCloudsCheck(RenderGlobal renderGlobal, float f2, int n2, double d2, double d3, double d4) {
        if (this.g.gameSettings.shouldRenderClouds() != 0 && !Optimization.a) {
            this.g.mcProfiler.endStartSection("clouds");
            GlStateManager.matrixMode((int)5889);
            GlStateManager.loadIdentity();
    ...
    public void setupCOverlayRendering() {
        utils.cy cy2 = new  utils.cy(this.g);
        GlStateManager.clear((int)256);
        GlStateManager.matrixMode((int)5889);
        GlStateManager.loadIdentity();
    ...
    private /* synthetic */ void updateFogColor(float f2) {
        ...
        vec3d3 = (Vec3d) ActiveRenderInfo.getBlockStateAtEntityViewpoint((World)this.g.world, (Entity)entity, (float)f2);
        if (this.z) {
    ...
    public void updateCameraAndRender(float f2, long l2) {
        ...
        this.g.mcProfiler.startSection("mouse");
        ...
        if (!this.g.skipRenderWorld) {
            ...
            if (this.g.world != null) {
                this.g.mcProfiler.startSection("level");
                ...
                this.g.mcProfiler.endStartSection("gui");
