...
import mahiro.deadcode.excluded.m;
import mahiro.deadcode.excluded.s;
...
extends InventoryEffectRenderer {
    ...
    private int selectedTabIndex = CreativeTabs.BUILDING_BLOCKS.getTabIndex();
...
public s a;
    ...
    protected void handleMouseClick(Slot slot, int n2, int n3, ClickType clickType) {
        ...
        if (slot == null && this.selectedTabIndex != CreativeTabs.INVENTORY.getTabIndex() && clickType != ClickType.QUICK_CRAFT) {
            ...
            } else if (this.selectedTabIndex == CreativeTabs.INVENTORY.getTabIndex()) {
    ...
    protected void drawGuiContainerForegroundLayer(int n2, int n3) {
        ...
        if (creativeTabs != null && creativeTabs.drawInForegroundOfTab()) {
            ...
            this.fontRenderer.drawString(I18n.format((String)creativeTabs.getTranslatedTabLabel(), (Object[])new Object[0]), 8, 6, creativeTabs.getLabelColor());
        }
    }
    ...
    private /* synthetic */ boolean needsScrollBars() {
        ...
        return this.selectedTabIndex != CreativeTabs.INVENTORY.getTabIndex() && CreativeTabs.CREATIVE_TAB_ARRAY[this.selectedTabIndex].hasSearchBar() && ((m)this.inventorySlots).a();
    }
    ...
    private /* synthetic */ void setCurrentCreativeTab(CreativeTabs creativeTabs) {
        ...
        int n2 = this.selectedTabIndex;
        this.selectedTabIndex = creativeTabs.getTabIndex();
        m m2 = (m)this.inventorySlots;
        ...
        } else if (n2 == CreativeTabs.INVENTORY.getTabIndex()) {
    ...
    public void drawScreen(int n2, int n3, float f2) {
        ...
        if (this.destroyItemSlot != null && this.selectedTabIndex == CreativeTabs.INVENTORY.getTabIndex() && this.isPointInRegion(this.destroyItemSlot.xPos, this.destroyItemSlot.yPos, 16, 16, n2, n3)) {
            this.drawHoveringText(I18n.format((String)"inventory.binSlot", (Object[])new Object[0]), n2, n3);
        }
        if (this.maxPages != 0) {
            String string = String.format("%utils.d / %utils.d", tabPage + 1, this.maxPages + 1);
    ...
    protected void drawGuiContainerBackgroundLayer(float f2, int n2, int n3) {
        ...
        for (CreativeTabs creativeTabs2 : Arrays.copyOfRange(CreativeTabs.CREATIVE_TAB_ARRAY, n4, n5)) {
            ...
            if (creativeTabs2 == null || creativeTabs2.getTabIndex() == this.selectedTabIndex) continue;
    ...
    protected boolean isMouseOverTab(CreativeTabs creativeTabs, int n2, int n3) {
        ...
        int n4 = creativeTabs.getTabColumn();
        int n5 = 28 * n4;
        int n6 = 0;
        ...
        n6 = creativeTabs.isTabInFirstRow() ? (n6 -= 32) : (n6 += this.ySize);
    ...
    protected boolean renderCreativeInventoryHoveringText(CreativeTabs creativeTabs, int n2, int n3) {
        ...
        if (this.isPointInRegion(n5 + 3, n6 + 3, 23, 27, n2, n3)) {
            this.drawHoveringText(I18n.format((String)creativeTabs.getTranslatedTabLabel(), (Object[])new Object[0]), n2, n3);
            return true;
        }
        return false;
    }
    ...
    protected void drawTab(CreativeTabs creativeTabs) {
        boolean bl = creativeTabs.getTabIndex() == this.selectedTabIndex;
        boolean bl2 = creativeTabs.isTabInFirstRow();
        int n2 = creativeTabs.getTabColumn();
        int n3 = n2 * 28;
        int n4 = 0;
    ...
    public static void handleHotbarSnapshots(Minecraft minecraft, int n2, boolean bl, boolean bl2) {
        ...
        if (bl) {
            ...
            for (int i3 = 0; i3 < InventoryPlayer.getHotbarSize(); ++i3) {
                hotbarSnapshot.set(i3, (ItemStack) entityPlayerSP.inventory.getStackInSlot(i3).copy());
            }
    ...
    public static /* synthetic */ InventoryBasic g() {
