...
extends Hack {
    ...
    public void onClientTickEvent(TickEvent.ClientTickEvent clientTickEvent) {
        for (Entity entity : et.b()) {
            ...
            if (!this.a.getModeByIndex(0).isToggled() || !(entity instanceof EntityPlayer) || (entityOtherPlayerMP = (EntityOtherPlayerMP) entity) == null || !this.g.contains(entityOtherPlayerMP.getUniqueID())) continue;
            ...
            if (((Boolean)this.e.getObjectValue()).booleanValue()) {
                ...
                InventoryPlayer networkPlayerInfo;
