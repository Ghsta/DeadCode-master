...
import org.lwjgl.input.Mouse;import utils.*;

public class Nuker
extends Hack {
    public ModeValue a;
    public DoubleValue b;
    public final ArrayDeque<Set> c = new ArrayDeque();
    public BlockPos d;
    public float e;
    public float f;
    public int g;
    ...
    public Nuker() {
        super("Nuker", HackCategory.World);
        this.b("General");
    ...
    public void onClientTickEvent(TickEvent.ClientTickEvent clientTickEvent) {
        ...
        Stream<BlockPos> stream = StreamSupport.stream(BlockPos.getAllInBox((BlockPos) blockPos2.add(n2, n2, n2), (BlockPos)blockPos2.add(-n2, -n2, -n2)).spliterator(), true);
