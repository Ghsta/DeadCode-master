...
extends Hack {
    ...
    public void onClientTickEvent(TickEvent.ClientTickEvent clientTickEvent) {
        ...
        for (n3 = 0; n3 < 4; ++n3) {
            ...
            if (et.a((ItemStack)object) || !(((ItemStack) object).getItem() instanceof ItemArmor)) continue;
            itemArmor = (ItemArmor)((ItemStack) object).getItem();
        ...
        while (((Iterator<?>) object).hasNext()) {
            ItemStack itemStack;
            int n5 = (Integer)((Iterator<?>) object).next();
            n2 = nArray[n5];
